...
Updated: 2025-08-26 (local) — Level Browser: implemented preview thumbnails and quick-play; list is searchable/filterable and scanning all sources. Editor: grid snapping helpers (nudges/alignment) completed. Prior notes retained below.
